...
Report printing and binding & $\sim$500 & Department requirement \\
\midrule
\textbf{Total} & $\sim$500 & \\
\bottomrule
\end{tabular}
...
\begin{figure}[H]
    ...
    \caption{Project Gantt chart. Milestones mark Proposal Defense (Jun 17), Mid-Term Defense (Jul 21), and Final Defense (Aug 31).}
